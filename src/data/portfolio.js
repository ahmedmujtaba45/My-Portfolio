export const personal = {
  ...
  subtitle: "Building tomorrow's tech, today.",
  intro:
    "Final-year Software Engineering student at CUST with a passion for Web Development, AI, cloud computing, and full-stack development. I love turning complex problems into elegant, scalable solutions.",
  ...
  education: [
    {
      ...
      period: "2023 – Present",
      details: "Registration: BSE231092",
    },
  ],
  goals:
...
export const courses = [
  {
    title: "Microsoft Front-End Certificate",
    provider: "Microsoft",
    year: "2026",
    description:
      "Demonstrates proficiency in HTML, CSS, JavaScript, C#, and responsive web development through Microsoft's professional certification program.",
  },
];
...
export const projects = [
  {
    id: 1,
    title: "AI-Powered Performance Evaluation Tool",
    badge: "FYP",
    description:
...
export const skills = [
  ...
  },
  {
    ...
    icon: "⬡",
    items: ["AWS", "Azure", "Git", "GitHub", "Docker", "Vercel"],
  },
  {
